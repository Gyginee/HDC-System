...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <p class="mb-4 mx-2">Oopss! 😱 Trang bạn đang tìm kiếm không tồn tại trên máy chủ này. Có vẻ như trang đó đã "biến mất" hoặc chúng tôi đã "lạc" nó rồi.</p>
    <a href="{{url('/')}}" class="btn btn-primary mb-4">Trờ vể</a>
    <div class="mt-4">
