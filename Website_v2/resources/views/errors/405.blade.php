...
@section('content')
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <p class="mb-4 mx-2">Xin lỗi, nhưng trang bạn đang cố gắng truy cập không hỗ trợ phương thức này. Phương thức
                HTTP bạn đã sử dụng không được chấp nhận trên tài nguyên này. Vui lòng kiểm tra lại yêu cầu của bạn.</p>
